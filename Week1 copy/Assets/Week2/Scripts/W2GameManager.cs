...
public class W2GameManager : MonoBehaviour
{
    ...
    //const means only this script can change it
    //gravity is all caps just for human readability purposes aka THIS IS A CONSTANT
    ...
    // HighScore is grabbing the value of highScore as an extra layer of security for highScore
    public int HighScore
    {
        ...
        set
        {
            // value is an implied parameter - its a keyword the compiler recognises
            highScore = value;
        }
    }
    ...
    // here we set a variable of the type W2GameManager (from game manager class) and call it instance
