...
public class DialogManager : MonoBehaviour
{
    ...
    void LoadJSONFromFile (string fileName)
    {
        ...
        // uses the simple JSON file to parse the text file and tell us things as a json as opposed to just a big string
        // the parenthises saying JSONObject is the part we're passing the string into a JSONObject
    ...
    public void ProgressStory()
    {
        ...
        // if there are more than 1 choice in the json, then run choice dialog, otherwise treat it like regular dialog
